...
htmlhelp_basename = 'autodocsummdoc'
...
latex_documents = [
  (master_doc, 'autodocsumm.tex', u'autodocsumm Documentation',
...
man_pages = [
    (master_doc, 'autodocsumm', u'autodocsumm Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'autodocsumm', u'autodocsumm Documentation',
   author, 'autodocsumm', 'Extending your autodoc API docs with a summary',
   'Miscellaneous'),
]
